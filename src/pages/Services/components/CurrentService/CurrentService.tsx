...
import PayServiceModal from "../../../../components/modals/PayServiceModal/PayServiceModal";
    ...
    <div className={classes.service}>
      <div className={classes.service_item_img}>
        {data && data?.images?.length > 0 && (
          <img
            src={data?.images[0].url_1536}
            className={classes.service_item_img}
          />
        )}
      </div>
      <div className={classes.service_item}>
        ...
        {data?.content && (
          <div
            ...
            className={classes.service_item_text}
          ></div>
        )}
        <ButtonDefault
