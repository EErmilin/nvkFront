    ...
    <div className={classes.main}>
      <div className={classes.main_links}>
        ...
        <div className={classes.main_links_wrp}>
          <div
            className={classes.main_links_item}
            onClick={() => navigate("/live?id=1")}
          >
            <NvkLogo />
          </div>
          <div
            className={classes.main_links_item}
            onClick={() => navigate("/live?id=2")}
          >
            <Mamont />
          </div>
          <div
            className={classes.main_links_item}
            onClick={() => navigate("/live?id=3")}
          >
            <Yakutia />
          </div>
          <div
            className={classes.main_links_item}
            onClick={() => navigate("/live?id=4")}
          >
            <Teteam />
          </div>
        </div>
      ...
      <div className={classes.main_musics}>
        ...
        <div className={classes.main_videos_wrp}>
          <div className={classes.main_musics_item}>
            <PodcastsButton
              style={{ height: 199 }}
              onClick={() => navigate("/audio?scroll=podcasts")}
            />
          </div>
          <div
            className={classes.main_musics_item}
      ...
      <div className={classes.main_news}>
        ...
        <div className={classes.main_news_wrp}>{templateNews}</div>
        <div className={classes.main_news_btn_wrp}>
          <button
            className={classes.main_news_btn}
            onClick={() => setTakeNews(takeNews + 4)}
          >
            Смотреть еще
          </button>
        </div>
      ...
      {streams && streams.length && (
        <div className={classes.main_live}>
          <h1 className={classes.main_title}>Прямые эфиры</h1>
          <div className={classes.main_live_wrp}>
            {streams.slice(0, 4).map((stream: any, key) => (
              <LiveItem stream={stream} key={key} />
            ))}
          </div>
          <div className={classes.main_news_btn_wrp}>
            <button
